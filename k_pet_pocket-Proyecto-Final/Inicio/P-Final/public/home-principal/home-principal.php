...
<head>
  ...
  <link href="../css/noticias.css" rel="stylesheet"  media="screen" />-->
...
<body>
    <div class="d-flex" id="content-wrapper">
        ...
        <div id="sidebar-container" class="">
            ...
            <div class="menu bg-primary">
                ...
                <a href="#" class="d-block text-dark p-3 border-0"><i class="fas fa-user-md mr-4"></i>
                    Ayuda</a>
                <a href="../perdidos-pet/home-perdidos.php" class="d-block text-dark p-3 border-0"><i
                        class="fas fa-user-md mr-4"></i>
                    Perdidos</a>
            </div>
        </div>
        <!-- Fin sidebar -->
                                ...
                                <div class="card rounded-2">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label id="pstr" for="">Cuentanos que tal tu día</label>
                                            <div class="card" id="post">
                                                <i class="fas fa-comment-alt fa-lg" id="coment"></i> <a
                                                    href="post-foto.php" id="enPost"> Escribe aqui lo que piensas</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    $query = "SELECT * FROM tabla_presumir";
    ...
    ?>
                                <div class="card rounded-2">
                                    <div class="card-body">
                                        <div class="header">
                                            <img src="../xdiseño/assets/prfil.jpg" id="imgCard" alt="">
                                            <a href="../perfil-pet/perfil.php"
                                                id="nameUser"><?php echo "" . $_SESSION['username'] . ""; ?></a>

                                            <div class="comentUser">
                                                <label class="font-weight-bold nombre_perfil text-dark" id="tl"
                                                    for=""><?php echo $row['nombre_mascota']; ?>
                                            </div>
                                            <div class="comentUser">
                                                <label class="" id="tl"
                                                    for=""><?php echo $row['descripcion']; ?></label>
                                            </div>
                                            <center>
                                                <a href="detalle-foto-adop.php" class="mt-4">
                                ...
                                <div class="card rounded-2">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                <a id="itm" href="eliminar.php?id=<?php echo $row['id']; ?>"><i
                        ...
                        <div class="row">
                            <div class="col-2" id="not">
                                ...
                                <div class="tienda">
                                    ...
                                    <div class="card1">
                                        <div class="cardImg">
                                            <a href="home-tienda.html"><img src="../xdiseño/assets/img/j1.jpg"
                                                    id="produc" alt=""></a>
                                            <div class="infor">
                                                <h6>Chompa</h6>
                                                <p>$20.00</p>
                                    ...
                                    <div class="card2">
                                        <div class="cardImg">
                                            <a href="home-tienda.html"> <img src="../xdiseño/assets/img/j2.jpg"
                                                    id="produc" alt=""></a>
                                            <div class="infor">

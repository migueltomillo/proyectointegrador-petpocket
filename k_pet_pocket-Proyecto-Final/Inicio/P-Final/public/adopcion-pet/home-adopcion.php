...
<body>
                                ...
                                <div class="card rounded-2">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label id="pstr" for="">¿Sabes de algun amigo peludo que busque un
                                                hogar?</label>
                                            <div class="card" id="post">
                                                <i class="fas fa-comment-alt fa-lg" id="coment"></i> <a
                                                    href="post-foto-Adop.php" id="enPost">Detalla aqui a la mascota que
                                                    busca un hogar..</a>
                                            </div>
                                        </div>
                                    </div>
    ...
    $query = "SELECT * FROM tabla_adopcion";

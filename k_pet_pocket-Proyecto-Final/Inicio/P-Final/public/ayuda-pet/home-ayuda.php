...
<head>
  ...
  <title>Pet-Pocket - Home Adopción</title>
</head>
            ...
            <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="perfil.php"><i class="fas fa-user mr-2"></i>Mi perfil</a>
                      ...
                      <div class="card rounded-2">
                          <div class="card-body">
                            <div class="form-group">
                              <label id="pstr" for="">¿Sabes de algun amigo peludo que busque un hogar?</label>
                              <div class="card" id="post">
                                  <i class="fas fa-comment-alt fa-lg"  id="coment" ></i> <a href="post-foto-Adop.php" id="enPost" >Detalla aqui a la mascota que busca un hogar..</a>
                              </div>
                            </div>
                          </div>
                      </div>
                        ...
                        <div class="card-body">
                          <div class="header">
                            ...
                            <div class="comentUser">
                                <label class="" id="tl" for="">Lindo Cachorrito busca un hogar</label>
                            </div>
                            <a href="detalle-foto-adop.php" class="mt-4"><img src="../xdiseño/assets/img/adp.jpg" class="mx-auto d-block img-fluid" id="imgPost" alt=""></a>
                          </div>
                        </div>
                      </div>
                      <div class="card rounded-2">
          ...
          <div class="row">               
            <div class="col-2" id="not"> 
                ...
                <div class="tienda">
                    ...
                    <div class="card1">                      
                            <div class="cardImg">
                               <a href="home-tienda.html"><img src="../assets/img/j1.jpg" id="produc" alt=""></a> 
                                <div class="infor">
                                    <h6>Chompa</h6>
                                    <p>$20.00</p>
                                </div>
                    ...
                    <div class="card2">                      
                        <div class="cardImg">
                          <a href="home-tienda.html"> <img src="../assets/img/j2.jpg" id="produc" alt=""></a>
                            <div class="infor">

          ...
          <div class="container">
              <div class="row">
                  <div class="col-lg-9 col-md-8">
                      <h3 class="mt-3 font-weight-bold">Hacer una Publicación</h3>
                  </div>
              ...
              <div class="col-6 my-4">
                <div class="card rounded-0">
                  <div class="card-body">
                    ...
                    <div class="button">
                      <label class="btn btn-outline-secondary w-100 align-self-center mt-3" for="uploadImage"></i>Seleccionar Foto

...
<head>
  ...
  <title>Pet-Pocket - Home - Adop</title>
</head>
          ...
          <div class="container">
              <div class="row">
                  <div class="col-lg-9 col-md-8">
                      <h3 class="mt-3 font-weight-bold">Publica a tu mascota perdida</h3>
                  </div>
            ...
            <div class="row">
              ...
              <div class="col-6 my-4">
                <div class="card rounded-0">
                  <div class="card-body">
                          <div class="header">
                              <img src="../xdiseño/assets/img/logo-perdido.png" id="imgCard" alt="">
                              <a href="../perfil-pet/perfil.php" id="nameUser" >Detalla a tu amigo perdido</a>
                              <br>                  
                              <div class="coments2">
                                        ...
                                        <div class="coments">
                                          ...
                                          <div class="row">
                                            <div class="col-sm-6" >
                                              ...
                                              <input type="text" name="raza_mascota" placeholder="Ej: Pitbull"  class="form-control"></input>
                                            </div>
                                            <div class="col-sm-6" >
                                             <label id="label" > Numero de Contacto </label>
                                              <input type="number" name="contacto" placeholder="098*******" class="form-control"></input>
                                            </div>
                                          </div>
                                          <br>
                                          <div class="row" >

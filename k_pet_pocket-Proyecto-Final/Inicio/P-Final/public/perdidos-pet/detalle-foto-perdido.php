...
<head>
  ...
  <title>Pet-Pocket - detalle - perdido</title>
</head>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 col-md-8">
                        <h3 class="mt-3 font-weight-bold">Descripción mascota perdida</h3>
                    </div>
            ...
            <div class="card rounded-0">
              <div class="card-body">
                      <div class="header">
                          ...
                          <a href="perfil.html" id="nameUser" >Mascotas perdidas</a>
                          ...
                          <div class="dropdown" style="float:left;">
                              <i class="fas fa-ellipsis-h" class="dropbtn"></i>
                               ...
                               <div class="dropdown-content" style="left:0;">
                                 ...
                                 <a href="post-foto-Update-perdido.php"><i class="fas fa-pen"></i>  Actualizar</a>
